...
class TestAll {
  public static void main(String[] args) {
    SieveOfEratosthenesSeq.main(args);
    SieveOfEratosthenesPara.main(args);
    FactorizeNumbers.main(args);
    // int n, k, threads;
    //
    // try {
    ...
    // System.out.println(
    // "Seq(" + soeSPrimes.length + ") and Para(" + soePPrimes.length + ") have
    // different lengths.");
    // return;
    // }
    //
    ...
    // FactorizeNumbers fn = new FactorizeNumbers(n - 1, k, soePPrimes, threads, new
    // Oblig3Precode(n));
    // // FactorizeNumbers fn = new FactorizeNumbers(n - 1, k, primes, threads, new
    // // Oblig3Precode(n));
